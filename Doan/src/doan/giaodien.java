    ...
    public void createInterface(){
        ...
        pctb.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) { // double click chuột trái để start/stop pc được chọn.
...
//        head.setSize(500, 70); head.setLocation(300, 5);
        ...
        crebg.setBorder(redBorder); TitledBorder b1 = new TitledBorder(redBorder, "Tạo tài khoản");
        crebg.setBorder(b1);
        ...
        pmbg.setBorder(greenBorder); TitledBorder b2 = new TitledBorder(blueBorder, "Nạp tiền");
        ...
        add_nl = new JLabel("Tiền nạp: "); add_nl.setSize(80, 30); add_nl.setLocation(5, 60); add_nl.setForeground(Color.white);
        ...
        pwdbg.setBorder(greenBorder); TitledBorder b3 = new TitledBorder(greenBorder, "Đổi mật khẩu");
        ...
        JButton exportStat = new JButton("Xuất báo cáo thống kê!"); exportStat.setSize(300, 40); exportStat.setLocation(440, 600);
           ...
           public void keyPressed(KeyEvent e) {
               if(e.getKeyCode() == KeyEvent.VK_ENTER){
                  ...
                  if (id.equals("admin") && String.valueOf(pass).equals("admin")){
                     ...
                     insertInto_actb();
                     insertInto_stattb();
                  }else{JOptionPane.showMessageDialog(jf,"Sai tài khoản");}
               }
           }
       });
...
//        }
     ...
     //  temp.TinhTien(money,java.time.LocalDate.now().toString());
       ...
       //
        ...
        if(uid.equals("khach")){
            ...
            insertInto_stattb();
            //
            JOptionPane.showMessageDialog(jf,"Máy "+id_temp+" .Tổng tiền: "+money);
            System.out.println(money);
            System.out.println(time);
        }else{
            Converter t = new Converter();
            t.SecToTime((int)time);
            JOptionPane.showMessageDialog(jf,"Máy "+id_temp+" .Tổng thời gian sử dụng "+t.GetHour()+":"+t.GetMin()+":"+t.GetSec());   
        }
    }
   ...
   public void handleChangepwdBtn(){
       ...
       if (db.CheckUPass(uid,String.valueOf(cpwd)) && db.UpdatePassword(uid, String.valueOf(npwd))) {
            JOptionPane.showMessageDialog(jf, "Đổi mật khẩu thành công!");
       }
       else {
           JOptionPane.showMessageDialog(jf, "Sai tài khoản hoặc mật khẩu!");
       }
   ...
   public void handlePayBtn(){
       ...
       if (!isNumber(add_nt.getText())){
           JOptionPane.showMessageDialog(jf,"Số tiền nạp không hợp lệ");
           return;
       }
       ...
       if(temp.AddTimeU(uid, time)){
           ...
           //refresh stat
            ...
            insertInto_stattb();
            //
           JOptionPane.showMessageDialog(jf,"Nạp thành công!");
           uid_nt.setText("");
           add_nt.setText("");
       }else{
           JOptionPane.showMessageDialog(jf,"User id không đúng!");
           uid_nt.setText("");
           add_nt.setText("");
       }
   }
   public void handlecreateBtn(){
       ...
       if(temp.CreateAcc(uid, String.valueOf(pw), time) && !uid.equals("khach")){
           JOptionPane.showMessageDialog(jf,"Tạo tài khoản thành công!");
           uid_at.setText("");
           pwd_at.setText("");
           add_at.setText("");
       }else{
           JOptionPane.showMessageDialog(jf,"Tài khoản đã tồn tại!");
       }
   }
